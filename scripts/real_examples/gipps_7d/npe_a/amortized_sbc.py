...
def main(N_iter, N_samp, amortized_posterior_ID, leader_trajectory_ID, num_components, test_function_name,
        aL, aU,
        bL, bU,
        VL, VU,
        xf0L, xf0U,
    ...
    # Generate ranks
    ranks = sbc_ranks(simulator_, prior, amortized_posterior, test_function=test_function, N_iter=N_iter, N_samp=N_samp)
...
if __name__ == "__main__":
    ...
    main(args.N_iter, args.N_samp, args.amortized_posterior_ID, args.leader_trajectory_ID, args.num_components, args.test_function_name,
        args.aL, args.aU,
        args.bL, args.bU,
        args.VL, args.VU,
        args.xf0L, args.xf0U,
