...
from examples.gipps import make_prior_7d_npe_c, simulator, get_test_function, all_test_function_names # Can use same make_prior as npe_c
...
def main(N_iter, N_samp, num_sequential_rounds, num_simulations_per_round,
        ...
        tau, N, ll, psi, bl, experiment_ID, density_estimator, sample_with,
    ...
    for n in range(N_iter):
        ...
        try:
            ...
            rank = sbc_ranks_tsnpe(simulator_,
                    prior,
        ...
        if (n == 0) and (not continue_experiment):
            ...
            assert(
                ...
                and config["sbc_config"]["sample_with"] == sample_with
                and config["sbc_config"]["epsilon"] == epsilon
                and config["sbc_config"]["restricted_prior_sample_with"] == restricted_prior_sample_with
                and config["sbc_config"]["num_samples_to_estimate_support"] == num_samples_to_estimate_support
            )
            if test_function_name=="all":
...
if __name__ == "__main__":
    ...
    main(args.N_iter, args.N_samp, args.num_sequential_rounds, args.num_simulations_per_round,
        ...
        args.tau, args.N, args.ll, args.psi, args.bl, args.experiment_ID,
        args.density_estimator, args.sample_with,
