...
results_path = str(path_to_repo / "results" / "toy_examples" / "unif_norm_high_d_data" / "npe_c")
...
def main(sigma, x_observed, num_sequential_rounds, num_simulations_per_round,
         d, k, L, U, use_combined_loss, density_estimator, num_repetitions):
    ...
    # Default x_observed is the k vector of zeros (i.e. of x_observed not passed in command line)
    if x_observed == []:
    ...
    for rep in range(num_repetitions):
        ...
        for r in range(num_sequential_rounds):
            ...
            # Don't compute squared norms for the prior
            if r > 0:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--k", type=int, required=True) # Data dimension
    ...
    main(args.sigma, args.x_observed, args.num_sequential_rounds,
         args.num_simulations_per_round, args.d, args.k, args.L, args.U, args.use_combined_loss,
