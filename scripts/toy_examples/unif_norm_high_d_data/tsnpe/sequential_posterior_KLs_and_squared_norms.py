...
results_path = str(path_to_repo / "results" / "toy_examples" / "unif_norm_high_d_data" / "tsnpe")
...
def main(sigma, x_observed, num_sequential_rounds, num_simulations_per_round,
         d, k, L, U, density_estimator, num_repetitions, epsilon, restricted_prior_sample_with, 
