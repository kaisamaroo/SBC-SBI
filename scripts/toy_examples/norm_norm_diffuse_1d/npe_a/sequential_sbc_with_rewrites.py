...
def main(sigma, N_iter, N_samp, num_sequential_rounds, num_simulations_per_round, num_components, experiment_ID):
    ...
    for n in range(N_iter):
        ...
        rank_sequential, sample_dict = sbc_ranks_snpe_a_and_samples(simulator,
                                prior,
        ...
        if (n == 0) and (not continue_experiment):
            # First rank: initialize the files
            config = {"sigma": sigma, 
                "N_iter": 1,
                "N_samp": N_samp,
                "num_sequential_rounds": num_sequential_rounds,
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.N_iter, args.N_samp, args.num_sequential_rounds, args.num_simulations_per_round, args.num_components, args.experiment_ID)
