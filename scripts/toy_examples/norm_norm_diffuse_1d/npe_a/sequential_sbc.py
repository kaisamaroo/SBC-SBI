...
def main(sigma, N_iter, N_samp, num_sequential_rounds, num_simulations_per_round, num_components):    
    ...
    ranks_sequential, samples_dict = sbc_ranks_snpe_a_and_samples(simulator,
                            prior,
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.N_iter, args.N_samp, args.num_sequential_rounds, args.num_simulations_per_round, args.num_components)
