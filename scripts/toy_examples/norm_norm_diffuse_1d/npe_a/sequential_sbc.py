...
from sbc.sbc_tools import sbc_ranks_snpe_a, sbc_ranks
import argparse
...
def train_sequential_posterior(simulator, prior, x_observed, num_sequential_rounds, num_simulations_per_round, num_components):
...
def main(sigma, N_iter, N_samp, num_sequential_rounds, num_simulations_per_round, num_components, show_progress):
    prior = make_prior(sigma)
    print("Running SBC:")
    ranks_sequential = sbc_ranks_snpe_a(simulator,
                            prior,
    ...
    print("SBC finished.")
    save_path = results_path + f"/sequential_sbc_ranks_Niter{N_iter}_Nsamp{N_samp}_sig{sigma}_nspr{num_simulations_per_round}_nr{num_sequential_rounds}_nc{num_components}.npy"
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.N_iter, args.N_samp, args.num_sequential_rounds, args.num_simulations_per_round, args.num_components, args.show_progress)
