...
from sbc.sbc_tools import sbc_ranks_snpe_a_and_samples, sbc_ranks, train_snpe_a_posterior
import argparse
...
def main(sigma, N_iter, N_samp, num_sequential_rounds, num_simulations_per_round, num_components, checkpoint_percent):
    # Find next ID
    i = 0
    ...
    for checkpoint_id in range(int(100 / checkpoint_percent)):
        ...
        ranks_sequential_checkpoint, samples_dict_checkpoint = sbc_ranks_snpe_a_and_samples(simulator,
                                prior,
                                train_snpe_a_posterior,
                                test_function=None,
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.N_iter, args.N_samp, args.num_sequential_rounds, args.num_simulations_per_round, args.num_components, args.checkpoint_percent)
