...
results_path = str(path_to_repo / "results" / "toy_examples" / "unif_norm" / "nre")
...
def main(sigma, x_observed, num_sequential_rounds, num_simulations_per_round,
         d, L, U, classifier, num_repetitions, mcmc_method, save_posteriors):
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.x_observed, args.num_sequential_rounds,
         ...
         args.classifier, args.num_repetitions, args.mcmc_method, args.save_posteriors)