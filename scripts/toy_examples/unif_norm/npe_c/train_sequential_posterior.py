...
def main(sigma, x_observed, num_sequential_rounds, num_simulations_per_round, n, d, L, U):
    ...
    for r in range(num_sequential_rounds):
        ...
        data_samples = simulator(parameter_samples, sigma=sigma, n=n, d=d)
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.x_observed, args.num_sequential_rounds,
         args.num_simulations_per_round, args.n, args.d, args.L, args.U)