...
def main(sigma, num_simulations, d, L, U):
    ...
    density_estimator = inference.train(force_first_round_loss=True) # Amortized TSNPE is equivalent to NPE-C with first round loss = True
...
if __name__ == "__main__":
    ...
    main(args.sigma, args.num_simulations, args.d, args.L, args.U)